...
img1 = face_recognition.load_image_file('harsh.jpg')
img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2RGB)
img1Test = face_recognition.load_image_file('harsh2.jpg')
...
cv2.imshow('harsh', img1)
cv2.imshow('harsh Test', img1Test)
cv2.waitKey(0)
